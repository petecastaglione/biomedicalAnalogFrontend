...
def runDcOp(ascFilePath, simOutputPath):
    # r"" for raw string
...
ascFilePath = os.path.join(parent_dir, "test_foldedCascode.asc")

simOutputPath = "pyLTspiceSims"

ascObj = AscEditor(ascFilePath)

ascObj.set_component_value("M1", "W", "4u")
# runDcOp(ascFilePath, simOutputPath)
...
# mosfets = process_mosfet_data(os.path.join(simOutputPath, "test_foldedCascode_1.log")) #Replace with your file name
